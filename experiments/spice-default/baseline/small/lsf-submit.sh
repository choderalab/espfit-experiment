...
echo "# Small"
python ../baseline_metric.py --train_ratio ${train_ratio} --ckptfile ${ckptfile} --configfile ${configfile} --path_to_data ${path_to_data} --category small --forcefields amber14sb --forcefields openff-2.1.0
